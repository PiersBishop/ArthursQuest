...
Q:\MULTIMEDIA\SOFTWARE\GBDK2020\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -Wm-yn"ARTHURSQUEST" -Wl-yt2 -Wl-yo4 -Wl-ya4 -o ArthursQuest.gb stuff/main.o stuff/bank_0.o stuff/bank_1.o stuff/bank_2.o stuff/bank_3.o ../Plugins/hUGEDriver.obj.o
